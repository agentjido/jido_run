...
- Baseline extension controls from [Plugins](/docs/concepts/plugins).
...
4. Add runtime checks from [Error handling and recovery](/docs/guides/error-handling-and-recovery) before expanding scope.
