...
- Launch checks: [Plugins](/docs/concepts/plugins), [Actions and Validation](/training/actions-validation)
...
- Launch checks: [Signals and Routing](/training/signals-routing), [Error handling and recovery](/docs/guides/error-handling-and-recovery)
...
- Launch checks: [Error handling and recovery](/docs/guides/error-handling-and-recovery), [Production Readiness: Supervision, Telemetry, and Failure Modes](/training/production-readiness)
