...
- Validate design and operations assumptions with [Architecture](/docs/reference/behavior-first-architecture) and [Production Readiness Checklist](/docs/operations/production-readiness-checklist).

## Build guides at a glance
