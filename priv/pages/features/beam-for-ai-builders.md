...
| First proof path | [Counter Agent](/examples/counter-agent) (non-LLM) -> [Jido.AI Actions Runtime Demos](/examples/jido-ai-actions-runtime-demos) (LLM add-on) |
...
- **Training:** [LiveView integration](/docs/learn/liveview-integration), [Production readiness](/docs/learn/production-readiness)
