...
| First proof path | [Demand Tracker Agent](/examples/demand-tracker-agent) -> [Signals](/docs/concepts/signals) |
...
- **Concept guides:** [Signals](/docs/concepts/signals), [Directives](/docs/concepts/directives)
- **Reference docs:** [Architecture](/docs/reference/behavior-first-architecture), [Guides](/docs/guides)

## Get Building

Start with [Demand Tracker Agent](/examples/demand-tracker-agent), then validate your first route table with [Signals](/docs/concepts/signals).
