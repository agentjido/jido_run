...
| `llm_db` | [llm_db#101 fix: add explicit wire.protocol metadata for OpenAI models](https://github.com/agentjido/llmdb/pull/101) | `vkryukov` | 2026-01-30 |
...
| `llm_db` | [llm_db#98 Fix/test environment](https://github.com/agentjido/llmdb/pull/98) | `vkryukov` | 2026-01-28 |
| `llm_db` | [llm_db#96 Fix/issue 93](https://github.com/agentjido/llmdb/pull/96) | `vkryukov` | 2026-01-28 |
| `llm_db` | [llm_db#92 feat: Add pricing and billing support for tool usage](https://github.com/agentjido/llmdb/pull/92) | `vkryukov` | 2026-01-28 |
...
| `llm_db` | [llm_db#100 Make Responses API the default for OpenAI](https://github.com/agentjido/llmdb/issues/100) | 2026-01-30 |
